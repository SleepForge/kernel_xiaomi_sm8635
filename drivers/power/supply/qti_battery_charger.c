...
enum xm_property_id {
	XM_PROP_RESISTANCE_ID = 0,			// 0x00 - from resistance_show
	XM_PROP_VERIFY_DIGEST = 1,			// 0x01
	XM_PROP_CONNECTOR_TEMP = 2,			// 0x02 - from connector_temp_show/store
	XM_PROP_CONNECTOR_TEMP2 = 3,			// 0x03 - from connector_temp2_show
	XM_PROP_AUTHENTIC = 4,				// 0x04 - from authentic_show/store
	XM_PROP_BATTERY_ADAPT_POWER_MATCH = 5,		// 0x05 - from bap_match_show
	XM_PROP_CHIP_OK = 6,				// 0x06
	XM_PROP_VBUS_DISABLE = 7,			// 0x07
	XM_PROP_REAL_TYPE = 8,				// 0x08
	XM_PROP_THERMAL_BOARD_TEMP = 9,			// 0x09 - from thermal_board_temp_show
	XM_PROP_THERMAL_SCENE = 10,			// 0x0A
	XM_PROP_NTC_ALARM = 11,				// 0x0B - from ntc_alarm_show/store
	XM_PROP_CHARGER_USER_VALUE_MAP = 12,		// 0x0C
	XM_PROP_TWO_NTC_PARAMETER1 = 13,		// 0x0D
	XM_PROP_TWO_NTC_PARAMETER2 = 14,		// 0x0E
	XM_PROP_TWO_NTC_PARAMETER3 = 15,		// 0x0F
	XM_PROP_TWO_NTC_PARAMETER4 = 16,		// 0x10
	XM_PROP_TWO_NTC_PARAMETER5 = 17,		// 0x11
	XM_PROP_TWO_NTC_PARAMETER6 = 18,		// 0x12
	XM_PROP_VERIFY_PROCESS = 19,			// 0x13 - from verify_process_show/store
	XM_PROP_VDM_CMD_CHARGER_VERSION = 20,		// 0x14
	XM_PROP_VDM_CMD_CHARGER_VOLTAGE = 21,		// 0x15
	XM_PROP_VDM_CMD_CHARGER_TEMP = 22,		// 0x16
	XM_PROP_VDM_CMD_SESSION_SEED = 23,		// 0x17
	XM_PROP_VDM_CMD_AUTHENTICATION = 24,		// 0x18
	XM_PROP_VDM_CMD_VERIFIED = 25,			// 0x19
	XM_PROP_VDM_CMD_REMOVE_COMPENSATION = 26,	// 0x1A
	XM_PROP_VDM_CMD_REVERSE_AUTHEN = 27,		// 0x1B
	XM_PROP_CURRENT_STATE = 28,			// 0x1C
	XM_PROP_ADAPTER_ID = 29,			// 0x1D
	XM_PROP_ADAPTER_SVID = 30,			// 0x1E
	XM_PROP_PD_VERIFED = 31,			// 0x1F
	XM_PROP_PDO2 = 32,				// 0x20
	XM_PROP_UVDM_STATE = 33,			// 0x21
	XM_PROP_CHG_CFG = 34,				// 0x22
	XM_PROP_CP_MODE = 35,				// 0x23
	XM_PROP_BQ2597X_CHIP_OK = 36,			// 0x24
	XM_PROP_BQ2597X_SLAVE_CHIP_OK = 37,		// 0x25
	XM_PROP_BQ2597X_BUS_CURRENT = 38,		// 0x26
	XM_PROP_BQ2597X_SLAVE_BUS_CURRENT = 39,		// 0x27
	XM_PROP_BQ2597X_BUS_DELTA = 40,			// 0x28
	XM_PROP_BQ2597X_BUS_VOLTAGE = 41,		// 0x29
	XM_PROP_BQ2597X_BATTERY_PRESENT = 42,		// 0x2A
	XM_PROP_BQ2597X_SLAVE_BATTERY_PRESENT = 43,	// 0x2B
	XM_PROP_BQ2597X_BATTERY_VOLTAGE = 44,		// 0x2C
	XM_PROP_BQ2597X_BATTERY_TEMPERATURE = 45,	// 0x2D
	XM_PROP_DAM_OVPGATE = 46,			// 0x2E
	XM_PROP_MASTER_SMB1396_ONLINE = 47,		// 0x2F
	XM_PROP_MASTER_SMB1396_IIN = 48,		// 0x30
	XM_PROP_SLAVE_SMB1396_ONLINE = 49,		// 0x31
	XM_PROP_SLAVE_SMB1396_IIN = 50,			// 0x32
	XM_PROP_SMB_IIN_DIFF = 51,			// 0x33
	XM_PROP_CC_ORIENTATION = 52,			// 0x34
	XM_PROP_INPUT_SUSPEND = 53,			// 0x35
	XM_PROP_FASTCHGMODE = 54,			// 0x36
	XM_PROP_NIGHT_CHARGING = 55,			// 0x37
	XM_PROP_USBINTERFACE = 56,			// 0x38
	XM_PROP_SOC_DECIMAL = 57,			// 0x39
	XM_PROP_SOC_DECIMAL_RATE = 58,			// 0x3A
	XM_PROP_QUICK_CHARGE_TYPE = 59,			// 0x3B
	XM_PROP_APDO_MAX = 60,				// 0x3C
	XM_PROP_POWER_MAX = 61,				// 0x3D
	XM_PROP_DIE_TEMPERATURE = 62,			// 0x3E
	XM_PROP_SLAVE_DIE_TEMPERATURE = 63,		// 0x3F
	XM_PROP_WLS_START = 64,				// 0x40
	XM_PROP_TX_MACL = 65,				// 0x41
	XM_PROP_TX_MACH = 66,				// 0x42
	XM_PROP_RX_CRL = 67,				// 0x43
	XM_PROP_RX_CRH = 68,				// 0x44
	XM_PROP_RX_CEP = 69,				// 0x45
	XM_PROP_BT_STATE = 70,				// 0x46
	XM_PROP_REVERSE_CHG_MODE = 71,			// 0x47
	XM_PROP_REVERSE_CHG_STATE = 72,			// 0x48
	XM_PROP_RX_VOUT = 73,				// 0x49
	XM_PROP_RX_VRECT = 74,				// 0x4A
	XM_PROP_RX_IOUT = 75,				// 0x4B
	XM_PROP_TX_ADAPTER = 76,			// 0x4C
	XM_PROP_OP_MODE = 77,				// 0x4D
	XM_PROP_WLS_DIE_TEMP = 78,			// 0x4E
	XM_PROP_WLS_BIN = 79,				// 0x4F
	XM_PROP_WLSCHARGE_CONTROL_LIMIT = 80,		// 0x50
	XM_PROP_WLS_QUICK_CHARGE_CONTROL_LIMIT = 81,	// 0x51
	XM_PROP_FW_VER = 82,				// 0x52
	XM_PROP_TX_UUID = 83,				// 0x53
	XM_PROP_WLS_THERMAL_REMOVE = 84,		// 0x54
	XM_PROP_CHG_DEBUG = 85,				// 0x55
	XM_PROP_WLS_FW_STATE = 86,			// 0x56
	XM_PROP_WLS_CAR_ADAPTER = 87,			// 0x57
	XM_PROP_WLS_TX_SPEED = 88,			// 0x58
	XM_PROP_WLS_FC_FLAG = 89,			// 0x59
	XM_PROP_RX_SS = 90,				// 0x5A
	XM_PROP_RX_OFFSET = 91,				// 0x5B
	XM_PROP_RX_SLEEP_MODE = 92,			// 0x5C
	XM_PROP_LOW_INDUCTANCE_OFFSET = 93,		// 0x5D
	XM_PROP_SET_RX_SLEEP = 94,			// 0x5E
	XM_PROP_PEN_MACL = 95,				// 0x5F
	XM_PROP_PEN_MACH = 96,				// 0x60
	XM_PROP_TX_IOUT = 97,				// 0x61
	XM_PROP_TX_VOUT = 98,				// 0x62
	XM_PROP_PEN_SOC = 99,				// 0x63
	XM_PROP_PEN_HALL3 = 100,			// 0x64
	XM_PROP_PEN_HALL4 = 101,			// 0x65
	XM_PROP_PEN_HALL3_S = 102,			// 0x66
	XM_PROP_PEN_HALL4_S = 103,			// 0x67
	XM_PROP_PEN_PPE_HALL_N = 104,			// 0x68
	XM_PROP_PEN_PPE_HALL_S = 105,			// 0x69
	XM_PROP_PEN_TX_SS = 106,			// 0x6A
	XM_PROP_PEN_PLACE_ERR = 107,			// 0x6B
	XM_PROP_FAKE_SS = 108,				// 0x6C
	XM_PROP_WLS_END = 109,				// 0x6D
	XM_PROP_SHUTDOWN_DELAY = 110,			// 0x6E
	XM_PROP_FAKE_TEMP = 111,			// 0x6F
	XM_PROP_THERMAL_REMOVE = 112,			// 0x70
	XM_PROP_TYPEC_MODE = 113,			// 0x71
	XM_PROP_MTBF_CURRENT = 114,			// 0x72 - from mtbf_current_show/store
	XM_PROP_THERMAL_TEMP = 115,			// 0x73 - from xm_batt_update_work
	XM_PROP_FB_BLANK_STATE = 116,			// 0x74 - from usb_chg_lpd_check_work
	XM_PROP_SCREEN_CCTOG = 117,			// 0x75 - from screen_cctog_show/store
	XM_PROP_SOFTWARE_CID = 118,			// 0x76 - from software_cid_show
	XM_PROP_SMART_BATT = 119,			// 0x77 - from smart_batt_show/store
	XM_PROP_SMART_FV = 120,				// 0x78 - from smart_fv_show/store
	XM_PROP_SHIPMODE_COUNT_RESET = 121,		// 0x79 - from shipmode_count_reset_store
	XM_PROP_SPORT_MODE = 122,			// 0x7A - from sport_mode_show/store
	XM_PROP_BATT_CONNT_ONLINE = 123,		// 0x7B - from battcont_online_show
	XM_PROP_FAKE_CYCLE = 124,			// 0x7C - from fake_cycle_show/store
  	XM_PROP_AFP_TEMP = 125,				// 0x7D - from afp_temp_show
	XM_PROP_CC_SHORT_VBUS = 126,			// 0x7E - from cc_short_vbus_show
	XM_PROP_OTG_UI_SUPPORT = 127,			// 0x7F - from otg_ui_support_show
	XM_PROP_CID_STATUS = 128,			// 0x80 - from cid_status_show
	XM_PROP_CC_TOGGLE = 129,			// 0x81 - from cc_toggle_show/store
	XM_PROP_SMART_CHG = 130,			// 0x82
	XM_PROP_LOW_FAST_PARA = 131,			// 0x83
	XM_PROP_LOWFAST_SW_PARA = 132,			// 0x84
	XM_PROP_SMART_SIC_MODE = 133,			// 0x85
	XM_PROP_NVTFG_MONITOR_ISC = 134,		// 0x86
	XM_PROP_NVTFG_MONITOR_SOA = 135,		// 0x87
	XM_PROP_OVER_PEAK_FLAG = 136,			// 0x88
	XM_PROP_CURRENT_DEVIATION = 137,		// 0x89
	XM_PROP_POWER_DEVIATION = 138,			// 0x8A
	XM_PROP_AVERAGE_CURRENT = 139,			// 0x8B
	XM_PROP_AVERAGE_TEMPERATURE = 140,		// 0x8C
	XM_PROP_START_LEARNING = 141,			// 0x8D
	XM_PROP_STOP_LEARNING = 142,			// 0x8E
	XM_PROP_SET_LEARNING_POWER = 143,		// 0x8F
	XM_PROP_GET_LEARNING_POWER = 144,		// 0x90
	XM_PROP_GET_LEARNING_POWER_DEV = 145,		// 0x91
	XM_PROP_GET_LEARNING_TIME_DEV = 146,		// 0x92
	XM_PROP_SET_CONSTANT_POWER = 147,		// 0x93
	XM_PROP_GET_REMAINING_TIME = 148,		// 0x94
	XM_PROP_SET_REFERANCE_POWER = 149,		// 0x95
	XM_PROP_GET_REFERANCE_CURRENT = 150,		// 0x96
	XM_PROP_GET_REFERANCE_POWER = 151,		// 0x97
	XM_PROP_START_LEARNING_B = 152,			// 0x98
	XM_PROP_STOP_LEARNING_B = 153,			// 0x99
	XM_PROP_SET_LEARNING_POWER_B = 154,		// 0x9A
	XM_PROP_GET_LEARNING_POWER_B = 155,		// 0x9B
	XM_PROP_GET_LEARNING_POWER_DEV_B = 156,		// 0x9C
	XM_PROP_FG2_OVER_PEAK_FLAG = 157,		// 0x9D
	XM_PROP_FG2_CURRENT_DEVIATION = 158,		// 0x9E
	XM_PROP_FG2_POWER_DEVIATION = 159,		// 0x9F
	XM_PROP_FG2_AVERAGE_CURRENT = 160,		// 0xA0
	XM_PROP_FG2_AVERAGE_TEMPERATURE = 161,		// 0xA1
	XM_PROP_FG2_START_LEARNING = 162,		// 0xA2
	XM_PROP_FG2_STOP_LEARNING = 163,		// 0xA3
	XM_PROP_FG2_SET_LEARNING_POWER = 164,		// 0xA4
	XM_PROP_FG2_GET_LEARNING_POWER = 165,		// 0xA5
	XM_PROP_FG2_GET_LEARNING_POWER_DEV = 166,	// 0xA6
	XM_PROP_FG2_GET_LEARNING_TIME_DEV = 167,	// 0xA7
	XM_PROP_FG2_SET_CONSTANT_POWER = 168,		// 0xA8
	XM_PROP_FG2_GET_REMAINING_TIME = 169,		// 0xA9
	XM_PROP_FG2_SET_REFERANCE_POWER = 170,		// 0xAA
	XM_PROP_FG2_GET_REFERANCE_CURRENT = 171,	// 0xAB
	XM_PROP_FG2_GET_REFERANCE_POWER = 172,		// 0xAC
	XM_PROP_FG2_START_LEARNING_B = 173,		// 0xAD
	XM_PROP_FG2_STOP_LEARNING_B = 174,		// 0xAE
	XM_PROP_FG2_SET_LEARNING_POWER_B = 175,		// 0xAF
	XM_PROP_FG2_GET_LEARNING_POWER_B = 176,		// 0xB0
	XM_PROP_FG2_GET_LEARNING_POWER_DEV_B = 177,	// 0xB1
	XM_PROP_FG1_GET_DESIGN_CAPACITY = 178,		// 0xB2
	XM_PROP_FG2_GET_DESIGN_CAPACITY = 179,		// 0xB3
	XM_PROP_FG1_QMAX = 180,				// 0xB4
	XM_PROP_FG1_RM = 181,				// 0xB5
	XM_PROP_FG1_FCC = 182,				// 0xB6
	XM_PROP_FG1_SOH = 183,				// 0xB7
	XM_PROP_FG1_FCC_SOH = 184,			// 0xB8
	XM_PROP_FG1_CYCLE = 185,			// 0xB9
	XM_PROP_FG1_FAST_CHARGE = 186,			// 0xBA
	XM_PROP_FG1_CURRENT_MAX = 187,			// 0xBB
	XM_PROP_FG1_VOL_MAX = 188,			// 0xBC
	XM_PROP_FG1_TSIM = 189,				// 0xBD
	XM_PROP_FG1_TAMBIENT = 190,			// 0xBE
	XM_PROP_FG1_TREMQ = 191,			// 0xBF
	XM_PROP_FG1_TFULLQ = 192,			// 0xC0
	XM_PROP_FG1_RSOC = 193,				// 0xC1
	XM_PROP_FG1_AI = 194,				// 0xC2
	XM_PROP_FG1_CELL1_VOL = 195,			// 0xC3
	XM_PROP_FG1_CELL2_VOL = 196,			// 0xC4
	XM_PROP_FG1_TEMP_MAX = 197,			// 0xC5
	XM_PROP_FG2_TEMP_MAX = 198,			// 0xC6
	XM_PROP_FG1_TIME_HT = 199,			// 0xC7
	XM_PROP_FG1_TIME_OT = 200,			// 0xC8
	XM_PROP_FG1_SEAL_SET = 201,			// 0xC9
	XM_PROP_FG1_SEAL_STATE = 202,			// 0xCA
	XM_PROP_FG1_DF_CHECK = 203,			// 0xCB
	XM_PROP_FG2_RM = 204,				// 0xCC
	XM_PROP_MAX_LIFE_VOL = 205,			// 0xCD
	XM_PROP_MAX_LIFE_TEMP = 206,			// 0xCE
	XM_PROP_OVER_VOL_DURATION = 207,		// 0xCF
	XM_PROP_FG2_FCC = 208,				// 0xD0
	XM_PROP_FG2_SOH = 209,				// 0xD1
	XM_PROP_FG2_CYCLE = 210,			// 0xD2
	XM_PROP_FG2_FAST_CHARGE = 211,			// 0xD3
	XM_PROP_FG2_CURRENT_MAX = 212,			// 0xD4
	XM_PROP_FG2_VOL_MAX = 213,			// 0xD5
	XM_PROP_FG2_RSOC = 214,				// 0xD6
	XM_PROP_FG1_SOC = 215,				// 0xD7
	XM_PROP_FG2_SOC = 216,				// 0xD8
	XM_PROP_FG1_IBATT = 217,			// 0xD9
	XM_PROP_FG2_IBATT = 218,			// 0xDA
	XM_PROP_FG1_VOL = 219,				// 0xDB
	XM_PROP_FG2_VOL = 220,				// 0xDC
	XM_PROP_FG1_TEMP = 221,				// 0xDD
	XM_PROP_FG2_TEMP = 222,				// 0xDE
	XM_PROP_FG1_ORITEMP = 223,			// 0xDF
	XM_PROP_FG2_ORITEMP = 224,			// 0xE0
	XM_PROP_FG2_AI = 225,				// 0xE1
	XM_PROP_FG1_FC = 226,				// 0xE2
	XM_PROP_FG2_FC = 227,				// 0xE3
	XM_PROP_FG2_QMAX = 228,				// 0xE4
	XM_PROP_FG2_TSIM = 229,				// 0xE5
	XM_PROP_FG2_TAMBIENT = 230,			// 0xE6
	XM_PROP_FG2_TREMQ = 231,			// 0xE7
	XM_PROP_FG2_TFULLQ = 232,			// 0xE8
	XM_PROP_FG1_IMAX = 233,				// 0xE9
	XM_PROP_DOT_TEST = 234,				// 0xEA
	XM_PROP_FG_VENDOR_ID = 235,			// 0xEB
	XM_PROP_PACK_VENDOR_ID = 236,			// 0xEC
	XM_PROP_CELL_VENDOR_ID = 237,			// 0xED
	XM_PROP_DOD_COUNT = 238,			// 0xEE
	XM_PROP_DOD_COUNTLT = 239,			// 0xEF
	XM_PROP_DOUBLE85 = 240,				// 0xF0
	XM_PROP_SOH_NEW = 241,				// 0xF1
	XM_PROP_REMOVE_TEMP_LIMIT = 242,		// 0xF2
	XM_PROP_HAS_DP = 243,				// 0xF3
	XM_PROP_LPD_CONTROL = 244,			// 0xF4
	XM_PROP_LPD_SBU1 = 245,				// 0xF5
	XM_PROP_LPD_SBU2 = 246,				// 0xF6
	XM_PROP_LPD_CC1 = 247,				// 0xF7
	XM_PROP_LPD_CC2 = 248,				// 0xF8
	XM_PROP_PLATE_SHOCK = 249,			// 0xF9
	XM_PROP_CALC_RVALUE = 250,			// 0xFA
	XM_PROP_LPD_DP = 251,				// 0xFB
	XM_PROP_LPD_DM = 252,				// 0xFC
	XM_PROP_LPD_UART_SLEEP = 253,			// 0xFD
	XM_PROP_LPD_CHARGING = 254,			// 0xFE
	XM_PROP_MAX_TEMP_OCCUR_TIME = 255,		// 0xFF
	XM_PROP_RUN_TIME = 256,				// 0x100
	XM_PROP_MAX_TEMP_TIME = 257,			// 0x101
	XM_PROP_HANDLE_STATE = 258,			// 0x102
	XM_PROP_HANDLE_STOP_CHARGING = 259,		// 0x103
	XM_PROP_SC760X_CHIP_OK = 260,			// 0x104
	XM_PROP_SC760X_SLAVE_CHIP_OK = 261,		// 0x105
	XM_PROP_SC760X_SLAVE_IBATT_LIMIT = 262,		// 0x106
	XM_PROP_DUMMY_0 = 263,				// 0x107
	XM_PROP_DUMMY_1 = 264,				// 0x108
	XM_PROP_DUMMY_2 = 265,				// 0x109
	XM_PROP_QBG_CURR = 266,				// 0x10A
	XM_PROP_REVERSE_QUICK_CHARGE = 267,		// 0x10B
	XM_PROP_LAST_NODE = 268,			// 0x10C
	XM_PROP_MAX = 269,				// 0x10D
};

/* Complete property ID mapping extracted from stock decompiled module qti_battery_charger.ko */
enum xm_property_id_2 {
	XM_PROP2_RESISTANCE_ID = 0x00,			// from resistance_show
	XM_PROP2_VERIFY_DIGEST = 0x01,			// from quick_charge_type_show
	XM_PROP2_CONNECTOR_TEMP = 0x02,			// from connector_temp_show/store
	XM_PROP2_CONNECTOR_TEMP2 = 0x03,		// from connector_temp2_show
	XM_PROP2_AUTHENTIC = 0x04,			// from authentic_show/store
	XM_PROP2_BATTERY_ADAPT_POWER_MATCH = 0x05,	// from bap_match_show
	XM_PROP2_CHIP_OK = 0x06,			// chip_ok related
	XM_PROP2_VBUS_DISABLE = 0x07,			// vbus disable
	XM_PROP2_REAL_TYPE = 0x08,			// from usb_chg_lpd_check_work
	XM_PROP2_THERMAL_BOARD_TEMP = 0x09,		// from thermal_board_temp_show
	XM_PROP2_THERMAL_SCENE = 0x0A,			// thermal_scene
	XM_PROP2_NTC_ALARM = 0x0B,			// from ntc_alarm_show/store
	XM_PROP2_CHARGER_USER_VALUE_MAP = 0x0C,		// from charger_user_value_map_show/store
	XM_PROP2_TWO_NTC_PARAMETER1 = 0x0D,		// from two_ntc_parameter1_show/store
	XM_PROP2_TWO_NTC_PARAMETER2 = 0x0E,		// from two_ntc_parameter2_show/store
	XM_PROP2_TWO_NTC_PARAMETER3 = 0x0F,		// from two_ntc_parameter3_show/store
	XM_PROP2_TWO_NTC_PARAMETER4 = 0x10,		// from two_ntc_parameter4_show/store
	XM_PROP2_TWO_NTC_PARAMETER5 = 0x11,		// from two_ntc_parameter5_show/store
	XM_PROP2_TWO_NTC_PARAMETER6 = 0x12,		// from two_ntc_parameter6_show/store
	XM_PROP2_VERIFY_PROCESS = 0x13,			// from verify_process_show/store
	XM_PROP2_RESISTANCE_SHOW = 0x16,		// from resistance_show
	XM_PROP2_CHARGE_CONTROL_EN = 0x19,		// from charge_control_en_show/store
	XM_PROP2_CURRENT_STATE = 0x1C,			// from current_state_show
	XM_PROP2_ADAPTER_ID = 0x1D,			// from adapter_id_show
	XM_PROP2_ADAPTER_SVID = 0x1E,			// from adapter_svid_show
	XM_PROP2_PD_VERIFED = 0x1F,			// from pd_verifed_show/store
	XM_PROP2_PDO2 = 0x20,				// from pdo2_show
	XM_PROP2_UT_TEST = 0x22,			// from ut_test_show
	XM_PROP2_CP_MODE = 0x23,			// from cp_mode_show/store
	XM_PROP2_BQ2597X_CHIP_OK = 0x24,		// from bq2597x_chip_ok_show
	XM_PROP2_BQ2597X_SLAVE_CHIP_OK = 0x25,		// from bq2597x_slave_chip_ok_show
	XM_PROP2_BQ2597X_BUS_CURRENT = 0x26,		// from bq2597x_bus_current_show
	XM_PROP2_BQ2597X_SLAVE_BUS_CURRENT = 0x27,	// from bq2597x_slave_bus_current_show
	XM_PROP2_BQ2597X_BUS_DELTA = 0x28,		// from bq2597x_bus_delta_show
	XM_PROP2_BQ2597X_BUS_VOLTAGE = 0x29,		// from bq2597x_bus_voltage_show
	XM_PROP2_BQ2597X_BATTERY_PRESENT = 0x2A,	// from bq2597x_battery_present_show
	XM_PROP2_BQ2597X_SLAVE_BATTERY_PRESENT = 0x2B,	// from bq2597x_slave_battery_present_show
	XM_PROP2_BQ2597X_BATTERY_VOLTAGE = 0x2C,	// from bq2597x_battery_voltage_show
	XM_PROP2_BQ2597X_BATTERY_TEMPERATURE = 0x2D,	// from bq2597x_battery_temp_show
	XM_PROP2_DAM_OVPGATE = 0x2E,			// from dam_ovpgate_show/store
	XM_PROP2_CC_ORIENTATION = 0x34,			// from cc_orientation_show
	XM_PROP2_INPUT_SUSPEND = 0x35,			// from input_suspend_show/store
	XM_PROP2_FASTCHGMODE = 0x36,			// from fastchg_mode_show
	XM_PROP2_NIGHT_CHARGING = 0x37,			// from night_charging_show/store
	XM_PROP2_USBINTERFACE = 0x38,			// from usbinterface_show/store
	XM_PROP2_SOC_DECIMAL = 0x39,			// from soc_decimal_show
	XM_PROP2_SOC_DECIMAL_RATE = 0x3A,		// from soc_decimal_rate_show
	XM_PROP2_APDO_MAX = 0x3C,			// from apdo_max_show
	XM_PROP2_POWER_MAX = 0x3D,			// from power_max_show
	XM_PROP2_PEN_HALL3 = 0x48,			// from pen_charge_notifier_work
	XM_PROP2_PEN_HALL4 = 0x64,			// from pen_charge_notifier_work
	XM_PROP2_REVERSE_CHG_STATE = 0x65,		// from pen_charge_notifier_work
	XM_PROP2_SHUTDOWN_DELAY = 0x6E,			// from shutdown_delay_show
	XM_PROP2_FAKE_TEMP = 0x6F,			// from fake_temp_show/store
	XM_PROP2_THERMAL_REMOVE = 0x70,			// from thermal_remove_show/store
	XM_PROP2_TYPEC_MODE = 0x71,			// from typec_mode_show
	XM_PROP2_MTBF_CURRENT = 0x72,			// from mtbf_current_show/store
	XM_PROP2_THERMAL_TEMP = 0x73,			// from xm_batt_update_work
	XM_PROP2_FB_BLANK_STATE = 0x74,			// from usb_chg_lpd_check_work
	XM_PROP2_SCREEN_CCTOG = 0x75,			// from screen_cctog_show/store
	XM_PROP2_SOFTWARE_CID = 0x76,			// from software_cid_show
	XM_PROP2_SMART_BATT = 0x77,			// from smart_batt_show/store
	XM_PROP2_SMART_FV = 0x78,			// from smart_fv_show/store
	XM_PROP2_SHIPMODE_COUNT_RESET = 0x79,		// from shipmode_count_reset_store
	XM_PROP2_SPORT_MODE = 0x7A,			// from sport_mode_show/store
	XM_PROP2_BATT_CONNT_ONLINE = 0x7B,		// from battcont_online_show
	XM_PROP2_FAKE_CYCLE = 0x7C,			// from fake_cycle_show/store
	XM_PROP2_AFP_TEMP = 0x7D,			// from afp_temp_show
	XM_PROP2_CC_SHORT_VBUS = 0x7E,			// from cc_short_vbus_show
	XM_PROP2_OTG_UI_SUPPORT = 0x7F,			// from otg_ui_support_show
	XM_PROP2_CID_STATUS = 0x80,			// from cid_status_show
	XM_PROP2_CC_TOGGLE = 0x81,			// from cc_toggle_show/store
	XM_PROP2_SMART_CHG = 0x82,			// from smart_chg_show/store
	XM_PROP2_LOW_FAST_PARA = 0x83,			// from low_fast_para_store
	XM_PROP2_LOWFAST_SW_PARA = 0x84,		// from lowfast_sw_para_store
	XM_PROP2_SMART_SIC_MODE = 0x85,			// from smart_sic_mode_show
	XM_PROP2_OPEN_LOADSW = 0x86,			// from open_loadsw_show/store
	XM_PROP2_NVTFG_MONITOR_ISC = 0x87,		// from battmoni_isc_show
	XM_PROP2_NVTFG_MONITOR_SOA = 0x88,		// from battmoni_soa_show
	XM_PROP2_OVER_PEAK_FLAG = 0x89,			// from over_peak_flag_show
	XM_PROP2_CURRENT_DEVIATION = 0x8A,		// from current_deviation_show
	XM_PROP2_POWER_DEVIATION = 0x8B,		// from power_deviation_show
	XM_PROP2_AVERAGE_CURRENT = 0x8C,		// from average_current_show
	XM_PROP2_AVERAGE_TEMPERATURE = 0x8D,		// from average_temp_show
	XM_PROP2_START_LEARNING = 0x8E,			// from start_learn_show/store
	XM_PROP2_STOP_LEARNING = 0x8F,			// from stop_learn_show/store
	XM_PROP2_SET_LEARNING_POWER = 0x90,		// from set_learn_power_show/store
	XM_PROP2_GET_LEARNING_POWER = 0x91,		// from get_learn_power_show
	XM_PROP2_GET_LEARNING_POWER_DEV = 0x92,		// from get_learn_power_dev_show
	XM_PROP2_GET_LEARNING_TIME_DEV = 0x93,		// from get_learn_time_dev_show
	XM_PROP2_SET_CONSTANT_POWER = 0x94,		// from constant_power_show/store
	XM_PROP2_GET_REMAINING_TIME = 0x95,		// from remaining_time_show
	XM_PROP2_SET_REFERANCE_POWER = 0x96,		// from referance_power_show/store
	XM_PROP2_GET_REFERANCE_CURRENT = 0x97,		// from nvt_referance_current_show
	XM_PROP2_GET_REFERANCE_POWER = 0x98,		// from nvt_referance_power_show
	XM_PROP2_START_LEARNING_B = 0x99,		// from start_learn_b_show/store
	XM_PROP2_STOP_LEARNING_B = 0x9A,		// from stop_learn_b_show/store
	XM_PROP2_SET_LEARNING_POWER_B = 0x9B,		// from set_learn_power_b_show/store
	XM_PROP2_GET_LEARNING_POWER_B = 0x9C,		// from get_learn_power_b_show
	XM_PROP2_GET_LEARNING_POWER_DEV_B = 0x9D,	// from get_learn_power_dev_b_show
	XM_PROP2_FG1_QMAX = 0xB5,			// from fg1_qmax_show
	XM_PROP2_FG1_RM = 0xB6,				// from fg1_rm_show
	XM_PROP2_FG1_FCC = 0xB7,			// from fg1_fcc_show
	XM_PROP2_FG1_SOH = 0xB8,			// from fg1_soh_show
	XM_PROP2_FG1_FCC_SOH = 0xB9,			// from fg1_fcc_soh_show
	XM_PROP2_FG1_CYCLE = 0xBA,			// from fg1_cycle_show
	XM_PROP2_FG1_FAST_CHARGE = 0xBB,		// from fg1_fastcharge_show
	XM_PROP2_FG1_CURRENT_MAX = 0xBC,		// from fg1_current_max_show
	XM_PROP2_FG1_VOL_MAX = 0xBD,			// from fg1_vol_max_show
	XM_PROP2_FG1_TSIM = 0xBE,			// from fg1_tsim_show
	XM_PROP2_FG1_TAMBIENT = 0xBF,			// from fg1_tambient_show
	XM_PROP2_FG1_TREMQ = 0xC0,			// from fg1_tremq_show
	XM_PROP2_FG1_TFULLQ = 0xC1,			// from fg1_tfullq_show
	XM_PROP2_FG1_RSOC = 0xC2,			// from fg1_rsoc_show
	XM_PROP2_FG1_AI = 0xC3,				// from fg1_ai_show
	XM_PROP2_FG1_TEMP_MAX = 0xC6,			// from fg1_temp_max_show
	XM_PROP2_FG2_TEMP_MAX = 0xC7,			// from fg2_temp_max_show
	XM_PROP2_FG1_TIME_HT = 0xC8,			// from fg1_time_ht_show
	XM_PROP2_FG1_TIME_OT = 0xC9,			// from fg1_time_ot_show
	XM_PROP2_FG1_SEAL_SET = 0xCA,			// from fg1_seal_set_show/store
	XM_PROP2_FG1_SEAL_STATE = 0xCB,			// from fg1_seal_state_show
	XM_PROP2_FG1_DF_CHECK = 0xCC,			// from fg1_df_check_show
	XM_PROP2_MAX_LIFE_VOL = 0xCD,			// from max_life_vol_show
	XM_PROP2_MAX_LIFE_TEMP = 0xCE,			// from max_life_temp_show
	XM_PROP2_OVER_VOL_DURATION = 0xCF,		// from over_vol_duration_show
	XM_PROP2_FG1_ORITEMP = 0xE2,			// from fg1_oritemp_show
	XM_PROP2_FG1_IMAX = 0xEC,			// from fg1_imax_show
	XM_PROP2_DOT_TEST = 0xED,			// from dot_test_store
	XM_PROP2_FG_VENDOR_ID = 0xEE,			// from fg_vendor_show
	XM_PROP2_PACK_VENDOR_ID = 0xEF,			// from pack_vendor_show
	XM_PROP2_CELL_VENDOR_ID = 0xF0,			// from cell_vendor_show
	XM_PROP2_DOD_COUNT = 0xF1,			// from dod_count_show/store
	XM_PROP2_DOD_COUNTLT = 0xF2,			// from dod_countLT_show/store
	XM_PROP2_DOUBLE85 = 0xF3,			// from double85_show/store
	XM_PROP2_SOH_NEW = 0xF4,			// from soh_new_show
	XM_PROP2_REMOVE_TEMP_LIMIT = 0xF5,		// from remove_temp_limit_show/store
	XM_PROP2_HAS_DP = 0xF6,				// from has_dp_show
	XM_PROP2_LPD_CONTROL = 0xF7,			// from lpd_control_show/store
	XM_PROP2_LPD_SBU1 = 0xF8,			// from sbu1_show/store
	XM_PROP2_LPD_SBU2 = 0xF9,			// from sbu2_show
	XM_PROP2_LPD_CC1 = 0xFA,			// from cc1_show
	XM_PROP2_LPD_CC2 = 0xFB,			// from cc2_show
	XM_PROP2_PLATE_SHOCK = 0xFC,			// from plate_shock_show/store
	XM_PROP2_CALC_RVALUE = 0xFD,			// from calc_rvalue_show
	XM_PROP2_LPD_DP = 0xFE,				// from dp_show
	XM_PROP2_LPD_DM = 0xFF,				// from dm_show
	XM_PROP2_LPD_UART_SLEEP = 0x100,		// from dis_uart_show/store
	XM_PROP2_LPD_CHARGING = 0x101,			// from lpd_charging_show
	XM_PROP2_QBG_CURR = 0x10A,			// from qbg_curr_show
	XM_PROP2_REVERSE_QUICK_CHARGE = 0x10B,		// from reverse_quick_charge_show/store
	XM_PROP2_LAST_NODE = 0x10C,			// from last_node_show
};
